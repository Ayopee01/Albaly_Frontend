...
export default function Loading({
  ...
  return (
    <div className={`relative flex ${heightClass} items-center justify-center ${className}`}>
      <div
        ...
        style={
          {
            "--hueMs": `${hueRotateDurationMs}ms`,
            "--sweepMs": `${sweepDurationMs}ms`,
          } as CSSVars
        }
      >
